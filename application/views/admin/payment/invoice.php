                                ...
                                <td>
                                    <?php if (empty($row->gambar)) : ?>
                                        <div class="flex items-center whitespace-nowrap text-danger">
                                            <i data-lucide="alert-circle" class="w-4 h-4 mr-2"></i>Belum upload bukti
                                        </div>
                                    <?php else : ?>
                                        <a href="<?= base_url() . '/uploads/' . $row->gambar ?>">
                                            <div class="flex items-center whitespace-nowrap text-primary">
                                                <i data-lucide="link" class="w-4 h-4 mr-2"></i>Lihat Bukti
                                            </div>
                                        </a>
                                    <?php endif; ?>
                                </td>
                                    ...
                                    <center>
                                        <?php if ($row->status == "0") : ?>
                                            <div class="flex justify-center items-center">
                                                <a class="flex items-center text-primary whitespace-nowrap" href="<?= site_url('admin/invoice/confirm/' . $row->order_id) ?>">
