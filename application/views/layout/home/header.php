    ...
    <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                <img alt="Midone - HTML Admin Template" class="w-6" src="<?= site_url('asset') ?>/admin/dist/images/logo.svg">
                <span class="text-white text-lg ml-3"> Voir Beauty </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('categories/skincare') ?>" class="side-menu side-menu">
                            <div class="side-menu__icon"> <i data-lucide="home"></i> </div>
                            <div class="side-menu__title">
                                Skincare
                                <div class="side-menu__sub-icon transform rotate-180"> </div>
                    ...
                    <li>
                        <a href="<?= base_url('categories/treatment') ?>" class="side-menu">
                    ...
                    <li>
                        <a href="<?= base_url('about/about') ?>" class="side-menu side-menu">
                            <div class="side-menu__icon"> <i data-lucide="home"></i> </div>
                            <div class="side-menu__title">
                                About
                                <div class="side-menu__sub-icon transform rotate-180"> </div>
